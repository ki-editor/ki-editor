...
Replace current selection with the previous/next text stored in the clipboard history.

The historical entries is grown by the following actions:
...
This is useful when you want to retrieve earlier copies or deleted texts.

<TutorialFallback filename="replace-history"/>
