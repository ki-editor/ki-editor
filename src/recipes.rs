...
// padding bottom 6
                    ...
                    file_extension: "rs",
                    prepare_events: keys!("n d f o o enter d"),
        ...
        RecipeGroup {
            ...
            recipes: [
                Recipe {
                    ...
                    events: keys!("d x l release-x v l release-v"),
...
"
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("s l l r j j release-r"),
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("s l l r l l release-r"),
                    expectations: Box::new([CurrentSelectedTexts(&["foo"])]),
                    terminal_height: None,
                    similar_vim_combos: &[],
                    only: false,
                ...
                Recipe {
                    ...
                    file_extension: "js",
                    prepare_events: keys!("w o"),
                    events: keys!("d g l r l release-r"),
                    expectations: Box::new([CurrentSelectedTexts(&["1 + 1"]), CurrentComponentContent("[1 + 1]")]),
                    terminal_height: None,
                    similar_vim_combos: &[],
                    only: false,
...
"
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("a l b l l release-b esc shift+Y"),
...
"
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("a l b l l release-b esc shift+P"),
                    expectations: Box::new([
                        CurrentSelectedTexts(&["1)", "20)", "300)"]),
                        CurrentComponentContent("
====
        ...
        RecipeGroup {
            ...
            recipes: [
                ...
                Recipe {
                    ...
                    file_extension: "js",
                    prepare_events: keys!("w o"),
                    events: keys!("d r o o o release-r"),
        ...
        RecipeGroup {
            ...
            recipes: [
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("s c release-c l v release-v"),
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("s l c release-c a v release-v"),
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("w l c release-c s v release-v"),
                    expectations: Box::new([CurrentComponentContent("Bar")]),
                    terminal_height: None,
                    similar_vim_combos: &[],
                    only: false,
...
"
                    ...
                    file_extension: "js",
                    prepare_events: &[],
                    events: keys!("d c release-c l v n release-v k l k l v release-v"),
        ...
        RecipeGroup {
            ...
            recipes: [
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("a c release-c v o release-v"),
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("a c release-c v u release-v"),
                    expectations: Box::new([CurrentComponentContent("foo barfoo bar")]),
                    terminal_height: None,
                    similar_vim_combos: &[],
                    only: false,
...
".trim(),
                    file_extension: "rs",
                    prepare_events: &[],
                    events: keys!("a c release-c l l d v i release-v"),
...
".trim(),
                    file_extension: "rs",
                    prepare_events: &[],
                    events: keys!("a c release-c l l d v k release-v"),
                    expectations: Box::new([CurrentComponentContent("
// foo
fn main() {
    fn bar() {
        ...
        RecipeGroup {
            ...
            recipes: [
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("s l c release-c j v l release-v"),
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("s l c release-c j / v j release-v"),
...
"
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("a c release-c v l release-v"),
                ...
                Recipe {
                    ...
                    events: keys!("d c release-c v l release-v"),
        ...
        RecipeGroup {
            ...
            recipes: [
                Recipe {
                    description: "Duplicate forward",
                    content: "foo bar".trim(),
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("a c ; release-c"),
                    expectations: Box::new([CurrentComponentContent("foo barfoo bar")]),
                    terminal_height: None,
                    similar_vim_combos: &[],
                    only: false,
        ...
        RecipeGroup {
            filename: "vertical-duplicate",
            recipes: [
                Recipe {
                    description: "Duplicate above",
                    content: "foo".trim(),
                    file_extension: "rs",
                    prepare_events: &[],
                    events: keys!("a c i release-c"),
                ...
                Recipe {
                    ...
                    file_extension: "rs",
                    prepare_events: &[],
                    events: keys!("a c k release-c"),
                    expectations: Box::new([
                        CurrentComponentContent("foo\nfoo".trim()),
        ...
        RecipeGroup {
            filename: "duplicate-with-gaps",
            recipes: [
                Recipe {
                    description: "Duplicate word forward",
                    content: "foo bar spam"
                    .trim(),
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("s l c l release-c"),
                    expectations: Box::new([CurrentComponentContent("foo bar bar spam")]),
                    terminal_height: None,
                    similar_vim_combos: &[],
                    only: false,
...
"#
                ...
                Recipe {
                    ...
                    file_extension: "json",
                    prepare_events: keys!("w o"),
                    events: keys!("d g l x space l l j release-x"),
                    expectations: Box::new([
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("a g l x space l l j release-x"),
                    expectations: Box::new([
                        CurrentSelectedTexts(&["foo\nbar"]),
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("w g l x space l l j release-x"),
                    expectations: Box::new([
        ...
        RecipeGroup {
            ...
            recipes: [
                Recipe {
                    ...
                    file_extension: "js",
                    prepare_events: keys!("n d x enter"),
                    events: keys!("d r space i release-r"),
                    expectations: Box::new([
...
<GParent>
    <Parent>
        ...
        <Brother/>
                        ...
                        .trim(),
                    file_extension: "js",
                    prepare_events: keys!("n d < c h i l d enter"),
                    events: keys!("d r space i release-r"),
                    expectations: Box::new([
...
app.post('/admin', () => { 
    return router.route(foo, bar) 
                    ...
                    .trim(),
                    file_extension: "js",
                    prepare_events: keys!("n d r o u t e r enter"),
                    events: keys!("d r space i i release-r"),
                    expectations: Box::new([
                ...
                Recipe {
                    ...
                    file_extension: "js",
                    prepare_events: keys!("n d 1 2 3 enter"),
                    events: keys!("d r space i i release-r"),
                    expectations: Box::new([
...
"
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("a b l b space release-b n d f o o enter r release-r"),
                    expectations: Box::new([
                        CurrentComponentContent(
                            "z bar y
bar x w
...
fn main(foo: str) {
    ...
    return foo;
                    ...
                    file_extension: "rs",
                    prepare_events: &[],
                    events: keys!("s l l n f a d b space release-b n r"),
                    expectations: Box::new([
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("s e release-e l l e release-e a b space release-b n e release-e"),
                    expectations: Box::new([
...
fn foo() {
   ...
   baz();
                    ...
                    file_extension: "rs",
                    prepare_events: &[],
                    events: keys!("a l , d . b space release-b a"),
...
foo ha"
                    ...
                    file_extension: "rs",
                    prepare_events: &[],
                    events: keys!("a b l b space release-b n d f o o enter s b space release-b w b space release-b k - enter"),
                    expectations: Box::new([CurrentSelectedTexts(&[
        ...
        RecipeGroup {
            ...
            recipes: [
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("a / s b j j release-b"),
                    expectations: Box::new([
                ...
                Recipe {
                    ...
                    .trim(),
                    file_extension: "md",
                    prepare_events: keys!("n d z enter"),
                    events: keys!("s p j b y release-b"),
                    expectations: Box::new([
        ...
        RecipeGroup {
            ...
            recipes: [Recipe {
                ...
                file_extension: "md",
                prepare_events: &[],
                events: keys!("n d w space f o enter l j"),
        ...
        RecipeGroup {
            ...
            recipes: [Recipe {
                ...
                file_extension: "md",
                prepare_events: &[],
                events: keys!("n d c space F o enter l j"),
                expectations: Box::new([CurrentSelectedTexts(&["Fo"])]),
                terminal_height: Some(7),
                similar_vim_combos: &[],
                only: false,
        ...
        RecipeGroup {
            ...
            recipes: [Recipe {
                ...
                file_extension: "md",
                prepare_events: &[],
                events: keys!("n d r space backslash ( . * backslash ) enter"),
        ...
        RecipeGroup {
            ...
            recipes: [Recipe {
                ...
                file_extension: "js",
                prepare_events: &[],
                events: keys!("n d n / f o space b a enter b space release-b j"),
        ...
        RecipeGroup {
            ...
            recipes: [Recipe {
                ...
                file_extension: "js",
                prepare_events: &[],
                events: keys!("n d a space f ( $ X ) enter"),
...
"#,
                    file_extension: "rs",
                    prepare_events: &[],
                    events: keys!("n d n / s e l e c t i o n space m o d e / f o o space b a r enter b space release-b j v m release-v r m"),
                    expectations: Box::new([]),
                    terminal_height: None,
                    similar_vim_combos: &[],
                    only: false,
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("n d l space f o space b a enter b l release-b v m release-v"),
        ...
        RecipeGroup {
            ...
            recipes: [
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("n d r space ( backslash d ) space ( $ 1 ) enter b space release-b j v m release-v"),
                ...
                Recipe {
                    ...
                    file_extension: "js",
                    prepare_events: &[],
                    events: keys!("n d n / f o space b a / k a _ t o enter b space release-b j v m release-v"),
                ...
                Recipe {
                    ...
                    file_extension: "js",
                    prepare_events: &[],
                    events: keys!("n d a space f ( $ X ) space ( $ X ) . z enter b space release-b j v m release-v"),
    ...
    "
                .trim(),
                file_extension: "rs",
                prepare_events: keys!("n d b enter"),
                events: keys!("d b space release-b j b space release-b i / / enter"),
                expectations: Box::new([
        ...
        "
                    ...
                    file_extension: "rs",
                    prepare_events: keys!("n d b enter"),
                    events: keys!("d b space release-b j b space release-b k / / enter"),
                    expectations: Box::new([CurrentSelectedTexts(&[
                        "Bar(baz)",
                        "Spam { what: String }",
                        "Fifa",
...
"
            ...
            file_extension: "md",
            prepare_events: &[],
            events: keys!("w n f b space release-b j"),
            expectations: Box::new([
...
"
            ...
            file_extension: "md",
            prepare_events: &[],
            events: keys!("w n f b space release-b j b space release-b l"),
        ...
        RecipeGroup {
            ...
            file_extension: "md",
            prepare_events: &[],
            events: keys!("w b space release-b j b ; ; n n n n release-b"),
        ...
        RecipeGroup {
            ...
            expectations: Box::new([CurrentComponentTitle("\u{200b} [-] 🦀 foo.rs \u{200b}\n [-] 🦀 main.rs ".to_string())]),
            terminal_height: Some(10),
            similar_vim_combos: &[],
            only: false,
        }].to_vec(),
        ...
        RecipeGroup {
            ...
            recipes: [
            Recipe {
            description: "Close current file and Unmark all buffers except the current",
            content: ""
            .trim(),
            file_extension: "md",
            prepare_events: keys!("space ; n d s r c enter enter n d m a enter enter e k release-e space ; n d f o enter enter e k release-e space ; n d t e m enter enter e k release-e space ; n d g i t enter enter"),
            events: keys!("e l n o o o k j i p o release-e"),
            expectations: Box::new([CurrentComponentTitle(" [÷] 📚 temp.md \n\u{200b} [ ] 🦀 main.rs \u{200b}".to_string())]),
            terminal_height: Some(10),
            similar_vim_combos: &[],
            only: false,
        }].to_vec(),
        ...
        RecipeGroup {
            ...
            Recipe {
                ...
                file_extension: "md",
                prepare_events: &[],
                events: keys!("s r l release-r r release-r l c release-c l f release-f esc l v y y y p p p release-v"),
...
"#
                    ...
                    file_extension: "rs",
                    prepare_events: &[],
                    events: keys!("n d p r i n t enter b space release-b j d r l release-r b , release-b"),
...
"#
                    ...
                    prepare_events: &[],
                    events: keys!(
                        "n d r / ^ - space backslash [ space backslash ] enter b space release-b j d c release-c r l release-r a p v l release-v ; backspace esc b space release-b l"
                    ),
...
"#
                    ...
                    prepare_events: &[],
                    events: keys!(
                        "n d y x enter d b space release-b j k l , s m h S o m e esc b space release-b l"
                    ),
...
3spam"
                ...
                file_extension: "md",
                prepare_events: &[],
                events: keys!("n d f o o enter space u l l j j space u"),
                expectations: Box::new([CurrentSelectedTexts(&["foo"])]),
                terminal_height: Some(9),
                similar_vim_combos: &[],
                only: false,
...
3spam"
            ...
            file_extension: "md",
            prepare_events: &[],
            events: keys!("n d f o o enter b space release-b j ; x esc s"),
...
"
            ...
            file_extension: "rs",
            prepare_events: &[],
            events: keys!("a l g s x space j j j j j j release-x"),
...
3spam"
            ...
            file_extension: "md",
            prepare_events: &[],
            events: keys!("n d f o o enter l v l release-v o l j j"),
            expectations: Box::new([CurrentSelectedTexts(&["foo"])]),
            terminal_height: Some(9),
            similar_vim_combos: &[],
            only: false,
...
"
        ...
        Recipe {
            ...
            file_extension: "md",
            prepare_events: &[],
            events: keys!("w r l release-r z j l release-z"),
...
"
            ...
            file_extension: "md",
            prepare_events: &[],
            events: keys!("w n f b l l release-b esc ; x"),
            expectations: Box::new([CurrentComponentContent(
                "foox bar spam
spam foox bar
bar spam foox
foo bar spam",
        ...
        Recipe {
            ...
            file_extension: "json",
            prepare_events: keys!("w o"),
            events: keys!("d g l c release-c r l release-r p v l release-v"),
        ...
        Recipe {
            ...
            file_extension: "md",
            prepare_events: &[],
            events: keys!("w r l release-r f release-f I esc"),
        ...
        Recipe {
            ...
            file_extension: "js",
            prepare_events: keys!("n d { enter"),
            events: keys!("d r space y p release-r"),
...
"
            .trim(),
            file_extension: "md",
            prepare_events: keys!("n d i f enter a"),
            events: keys!("alt+; alt+; alt+;"),
            expectations: Box::new([CurrentSelectedTexts(&[
                "If nautical nonsense be something you wish?",
            ])]),
        ...
        Recipe {
            ...
            events: keys!("c release-c i v n release-v i v n release-v k l v release-v"),
            expectations: Box::new([CurrentComponentContent(
        ...
        Recipe {
            ...
            events: keys!("c release-c i i v n release-v i i v n release-v k l k l v release-v"),
            expectations: Box::new([CurrentComponentContent(
    ...
    RecipeGroup {
        ...
        recipes: [
            Recipe {
                ...
                file_extension: "md",
                prepare_events: &[],
                events: keys!("s l t u release-t x"),
            ...
            Recipe {
                ...
                file_extension: "md",
                prepare_events: &[],
                events: keys!("s l t j release-t x"),
                expectations: Box::new([CurrentComponentContent("foo, x, bar spam")]),
                terminal_height: Some(10),
                similar_vim_combos: &[],
                only: false,
            ...
            Recipe {
                ...
                file_extension: "md",
                prepare_events: &[],
                events: keys!("s l t o release-t x"),
            ...
            Recipe {
                ...
                file_extension: "md",
                prepare_events: &[],
                events: keys!("s l t l release-t x"),
                expectations: Box::new([CurrentComponentContent("foo, bar, x spam")]),
                terminal_height: Some(10),
                similar_vim_combos: &[],
                only: false,
            ...
            Recipe {
                ...
                file_extension: "py",
                prepare_events: keys!("n d s p a m enter"),
                events: keys!("d t l release-t x esc t j release-t y"),
                expectations: Box::new([CurrentComponentContent(
...
"
                ...
                events: keys!("d t l release-t l e t space z"),
                expectations: Box::new([CurrentComponentContent(
                    "function foo() {
  let x = hello();
  let y = hey()
...
fn foo() {
    bar();
                ...
                file_extension: "md",
                prepare_events: &[],
                events: keys!("a l t i release-t y esc t k release-t x"),
                expectations: Box::new([CurrentComponentContent(
                    "fn foo() {
    y
    x
