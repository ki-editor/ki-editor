...
"
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("a f k r / f o o enter h"),
                    expectations: &[
...
foo ha"
                    ...
                    file_extension: "rs",
                    prepare_events: &[],
                    events: keys!("a f k r / f o o enter s r w r o - enter"),
                    expectations: &[CurrentSelectedTexts(&[
        ...
        RecipeGroup {
            ...
            recipes: [Recipe {
                ...
                file_extension: "md",
                prepare_events: &[],
                events: keys!("/ f o enter alt+/ w l j"),
        ...
        RecipeGroup {
            ...
            recipes: [Recipe {
                ...
                file_extension: "md",
                prepare_events: &[],
                events: keys!("/ F o enter alt+/ c l j"),
                expectations: &[CurrentSelectedTexts(&["Fo"])],
                terminal_height: Some(7),
                similar_vim_combos: &[],
                only: false,
        ...
        RecipeGroup {
            ...
            recipes: [
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("/ alt+/ x ( backslash d ) enter alt+/ r ( $ 1 ) enter R"),
                ...
                Recipe {
                    ...
                    file_extension: "js",
                    prepare_events: &[],
                    events: keys!("/ alt+/ n f o space b a enter alt+/ r k a _ t o enter R"),
                ...
                Recipe {
                    ...
                    file_extension: "js",
                    prepare_events: &[],
                    events: keys!("/ alt+/ a f ( $ X ) enter alt+/ r ( $ X ) . z enter R"),
...
"#
                    ...
                    prepare_events: &[],
                    events: keys!(
                        "alt+/ x / ^ - space backslash [ space backslash ] enter r r d c h a . v o backspace"
                    ),
...
"#
                    ...
                    prepare_events: &[],
                    events: keys!(
                        "/ y x enter d r r k l f n ( u S o m e esc d k l l X r m"
                    ),
                    expectations: &[],
                    terminal_height: None,
                    similar_vim_combos: &[],
...
"
            .trim(),
            file_extension: "md",
            prepare_events: keys!("/ i f enter a"),
