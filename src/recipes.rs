...
foo ha"
        ...
        RecipeGroup {
            ...
            recipes: [Recipe {
                ...
                file_extension: "md",
                prepare_events: &[],
                events: keys!("q f o enter alt+q w l j"),
        ...
        RecipeGroup {
            ...
            recipes: [Recipe {
                ...
                file_extension: "md",
                prepare_events: &[],
                events: keys!("q F o enter alt+q c l j"),
                expectations: &[CurrentSelectedTexts(&["Fo"])],
                terminal_height: Some(7),
                similar_vim_combos: &[],
                only: false,
        ...
        RecipeGroup {
            ...
            recipes: [Recipe {
                ...
                file_extension: "md",
                prepare_events: &[],
                events: keys!("q backslash ( . * backslash ) enter alt+q x"),
        ...
        RecipeGroup {
            ...
            recipes: [Recipe {
                ...
                file_extension: "js",
                prepare_events: &[],
                events: keys!("q f o space b a enter alt+q n l"),
        ...
        RecipeGroup {
            ...
            recipes: [Recipe {
                ...
                file_extension: "js",
                prepare_events: &[],
                events: keys!("q f ( $ X ) enter alt+q a"),
...
"#,
                    file_extension: "rs",
                    prepare_events: &[],
                    events: keys!("alt+q n q s e l e c t i o n space m o d e enter alt+q r f o o space b a r enter esc esc r r B r m"),
                    expectations: &[],
                    terminal_height: None,
                    similar_vim_combos: &[],
                    only: false,
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("q f o enter r l esc alt+q r b a enter esc esc B"),
        ...
        RecipeGroup {
            ...
            recipes: [
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("q alt+q x ( backslash d ) enter alt+q r ( $ 1 ) enter R"),
                ...
                Recipe {
                    ...
                    file_extension: "js",
                    prepare_events: &[],
                    events: keys!("q alt+q n f o space b a enter alt+q r k a _ t o enter R"),
                ...
                Recipe {
                    ...
                    file_extension: "js",
                    prepare_events: &[],
                    events: keys!("q alt+q a f ( $ X ) enter alt+q r ( $ X ) . z enter R"),
...
"#
                    ...
                    prepare_events: &[],
                    events: keys!(
                        "alt+q x q ^ - space backslash [ space backslash ] enter r r d c h a . v o backspace"
                    ),
...
"
        ...
        Recipe {
            ...
            events: keys!("c i i C i i C k l k l b"),
            expectations: &[CurrentComponentContent(
