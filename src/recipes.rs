...
"
                    ...
                    file_extension: "js",
                    prepare_events: &[],
                    events: keys!("d c release-c l x b release-x k l k l b release-b"),
        ...
        RecipeGroup {
            ...
            recipes: [
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("n d r space ( backslash d right space ( $ 1 enter r space release-r j b m release-b"),
                ...
                Recipe {
                    ...
                    file_extension: "js",
                    prepare_events: &[],
                    events: keys!("n d a space f ( $ X right space ( $ X right . z enter r space release-r j b m release-b"),
...
"
        ...
        Recipe {
            ...
            events: keys!("c release-c i x b release-x i x b release-x k l b release-b"),
            expectations: Box::new([CurrentComponentContent(
        ...
        Recipe {
            ...
            events: keys!("c release-c i i x b release-x i i x b release-x k l k l b release-b"),
            expectations: Box::new([CurrentComponentContent(
