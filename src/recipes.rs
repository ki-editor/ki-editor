...
foo ha"
                    ...
                    file_extension: "rs",
                    prepare_events: &[],
                    events: keys!("a g l r q f o o enter s r w r o - enter"),
                    expectations: Box::new([CurrentSelectedTexts(&[
...
"#
                    ...
                    prepare_events: &[],
                    events: keys!(
                        "q r / ^ - space backslash [ space backslash ] enter r r d c v l space a p . o backspace"
                    ),
...
"#
                    ...
                    prepare_events: &[],
                    events: keys!(
                        "q y x enter d r r k l g , j u S o m e esc d k l k T r f"
                    ),
                    expectations: Box::new([]),
                    terminal_height: None,
                    similar_vim_combos: &[],
...
foo bar spam",
        ...
        Recipe {
            ...
            file_extension: "json",
            prepare_events: keys!("w ;"),
            events: keys!("d g l c v l space p ."),
