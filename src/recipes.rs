...
"
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("s l l g j j release-g"),
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("s l l g l l release-g"),
                    expectations: Box::new([CurrentSelectedTexts(&["foo"])]),
                    terminal_height: None,
                    similar_vim_combos: &[],
                    only: false,
                ...
                Recipe {
                    ...
                    file_extension: "js",
                    prepare_events: keys!("w o"),
                    events: keys!("d b l g l release-g"),
                    expectations: Box::new([CurrentSelectedTexts(&["1 + 1"]), CurrentComponentContent("[1 + 1]")]),
                    terminal_height: None,
                    similar_vim_combos: &[],
                    only: false,
...
"
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("a l r l l release-r esc shift+Y"),
...
"
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("a l r l l release-r esc shift+P"),
                    expectations: Box::new([
                        CurrentSelectedTexts(&["1)", "20)", "300)"]),
                        CurrentComponentContent("
====
        ...
        RecipeGroup {
            ...
            recipes: [
                ...
                Recipe {
                    ...
                    file_extension: "js",
                    prepare_events: keys!("w o"),
                    events: keys!("d g o o o release-g"),
...
"#
                ...
                Recipe {
                    ...
                    file_extension: "json",
                    prepare_events: keys!("w o"),
                    events: keys!("d b l x space l l j release-x"),
                    expectations: Box::new([
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("a b l x space l l j release-x"),
                    expectations: Box::new([
                        CurrentSelectedTexts(&["foo\nbar"]),
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("w b l x space l l j release-x"),
                    expectations: Box::new([
        ...
        RecipeGroup {
            ...
            recipes: [
                Recipe {
                    ...
                    file_extension: "js",
                    prepare_events: keys!("n d x enter"),
                    events: keys!("d g space i release-g"),
                    expectations: Box::new([
...
app.post('/admin', () => { 
    return router.route(foo, bar) 
                    ...
                    events: keys!("d g space i i release-g"),
                    expectations: Box::new([
...
"
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("a b l r space release-r n d f o o enter g release-g"),
                    expectations: Box::new([
                        CurrentComponentContent(
                            "z bar y
bar x w
...
fn main(foo: str) {
    ...
    return foo;
                    ...
                    file_extension: "rs",
                    prepare_events: &[],
                    events: keys!("s l l n f a d r space release-r n r"),
                    expectations: Box::new([
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("s e release-e l l e release-e a r space release-r n e release-e"),
                    expectations: Box::new([
...
foo ha"
                    ...
                    file_extension: "rs",
                    prepare_events: &[],
                    events: keys!("a b l r space release-r n d f o o enter s r space release-r w r space release-r k - enter"),
                    expectations: Box::new([CurrentSelectedTexts(&[
        ...
        RecipeGroup {
            ...
            recipes: [
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("a / s r j j release-r"),
                    expectations: Box::new([
                ...
                Recipe {
                    ...
                    events: keys!("s p j r y release-r"),
                    expectations: Box::new([
        ...
        RecipeGroup {
            ...
            recipes: [Recipe {
                ...
                file_extension: "js",
                prepare_events: &[],
                events: keys!("n d n / f o space b a enter r space release-r j"),
...
"#,
                    file_extension: "rs",
                    prepare_events: &[],
                    events: keys!("n d n / s e l e c t i o n space m o d e / f o o space b a r enter r space release-r j v m release-v r m"),
                    expectations: Box::new([]),
                    terminal_height: None,
                    similar_vim_combos: &[],
                    only: false,
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("n d l space f o space b a enter r l release-r v m release-v"),
        ...
        RecipeGroup {
            ...
            recipes: [
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("n d r space ( backslash d ) space ( $ 1 ) enter r space release-r j v m release-v"),
                ...
                Recipe {
                    ...
                    file_extension: "js",
                    prepare_events: &[],
                    events: keys!("n d n / f o space b a / k a _ t o enter r space release-r j v m release-v"),
                ...
                Recipe {
                    ...
                    file_extension: "js",
                    prepare_events: &[],
                    events: keys!("n d a space f ( $ X ) space ( $ X ) . z enter r space release-r j v m release-v"),
    ...
    "
                ...
                events: keys!("d r space release-r j r space release-r i / / enter"),
                expectations: Box::new([
        ...
        "
                    ...
                    file_extension: "rs",
                    prepare_events: keys!("n d b enter"),
                    events: keys!("d r space release-r j r space release-r k / / enter"),
                    expectations: Box::new([CurrentSelectedTexts(&[
                        "Bar(baz)",
                        "Spam { what: String }",
                        "Fifa",
...
"
            ...
            file_extension: "md",
            prepare_events: &[],
            events: keys!("w n f r space release-r j"),
            expectations: Box::new([
...
"
            ...
            file_extension: "md",
            prepare_events: &[],
            events: keys!("w n f r space release-r j r space release-r l"),
        ...
        RecipeGroup {
            ...
            file_extension: "md",
            prepare_events: &[],
            events: keys!("w r space release-r j r ; ; n n n n release-r"),
        ...
        RecipeGroup {
            ...
            Recipe {
                ...
                file_extension: "md",
                prepare_events: &[],
                events: keys!("s g l release-g g release-g l c release-c l f release-f esc l v y y y p p p release-v"),
...
"#
                    ...
                    file_extension: "rs",
                    prepare_events: &[],
                    events: keys!("n d p r i n t enter r space release-r j d g l release-g r , release-r"),
...
"#
                    ...
                    prepare_events: &[],
                    events: keys!(
                        "n d r / ^ - space backslash [ space backslash ] enter r space release-r j d c release-c g l release-g a p v l release-v ; backspace esc r space release-r l"
                    ),
...
3spam"
            ...
            file_extension: "md",
            prepare_events: &[],
            events: keys!("n d f o o enter r space release-r j ; x esc s"),
...
"
            ...
            file_extension: "rs",
            prepare_events: &[],
            events: keys!("a l b s x space j j j j j j release-x"),
...
"
        ...
        Recipe {
            ...
            file_extension: "md",
            prepare_events: &[],
            events: keys!("w g l release-g z j l release-z"),
...
"
            ...
            file_extension: "md",
            prepare_events: &[],
            events: keys!("w n f r l l release-r esc ; x"),
            expectations: Box::new([CurrentComponentContent(
                "foox bar spam
spam foox bar
bar spam foox
foo bar spam",
        ...
        Recipe {
            ...
            file_extension: "json",
            prepare_events: keys!("w o"),
            events: keys!("d g l c release-c g l release-g p v l release-v"),
        ...
        Recipe {
            ...
            file_extension: "md",
            prepare_events: &[],
            events: keys!("w v l release-v f release-f I esc"),
        ...
        Recipe {
            ...
            events: keys!("d c release-c y g p b release-b"),
...
"
        ...
        Recipe {
            ...
            events: keys!("c release-c i v n release-v i v n release-v k l b release-b"),
            expectations: Box::new([CurrentComponentContent(
        ...
        Recipe {
            ...
            events: keys!("c release-c i i v n release-v i i v n release-v k l k l b release-b"),
            expectations: Box::new([CurrentComponentContent(
