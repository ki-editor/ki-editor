...
foo ha"
        ...
        RecipeGroup {
            ...
            recipes: [Recipe {
                ...
                file_extension: "md",
                prepare_events: &[],
                events: keys!("q f o enter alt+q ; l j"),
        ...
        RecipeGroup {
            ...
            recipes: [Recipe {
                ...
                file_extension: "md",
                prepare_events: &[],
                events: keys!("q F o enter alt+q j l j"),
                expectations: &[CurrentSelectedTexts(&["Fo"])],
                terminal_height: Some(7),
                similar_vim_combos: &[],
                only: false,
        ...
        RecipeGroup {
            ...
            recipes: [Recipe {
                ...
                file_extension: "md",
                prepare_events: &[],
                events: keys!("q backslash ( . * backslash ) enter alt+q f"),
        ...
        RecipeGroup {
            ...
            recipes: [Recipe {
                ...
                file_extension: "js",
                prepare_events: &[],
                events: keys!("q f o space b a enter alt+q s l"),
...
"#,
                    file_extension: "rs",
                    prepare_events: &[],
                    events: keys!("alt+q n q s e l e c t i o n space m o d e enter alt+q w f o o space b a r enter esc esc r r X r m"),
                    expectations: &[],
                    terminal_height: None,
                    similar_vim_combos: &[],
                    only: false,
                ...
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("q f o enter r l esc alt+q w b a enter esc esc X"),
        ...
        RecipeGroup {
            ...
            recipes: [
                Recipe {
                    ...
                    file_extension: "md",
                    prepare_events: &[],
                    events: keys!("q alt+q f ( backslash d ) enter alt+q w ( $ 1 ) enter x"),
                ...
                Recipe {
                    ...
                    file_extension: "js",
                    prepare_events: &[],
                    events: keys!("q alt+q s f o space b a enter alt+q w k a _ t o enter x"),
                ...
                Recipe {
                    ...
                    file_extension: "js",
                    prepare_events: &[],
                    events: keys!("q alt+q a f ( $ X ) enter alt+q w ( $ X ) . z enter x"),
...
"#
                    ...
                    prepare_events: &[],
                    events: keys!(
                        "alt+q f q ^ - space backslash [ space backslash ] enter r r d c h a . v o backspace"
                    ),
