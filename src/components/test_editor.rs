...
#[test]
fn parent_first_child_movement_from_syntax_node_selection_mode() -> anyhow::Result<()> {
    execute_test(|s| {
        Box::new([
            App(OpenFile(s.main_rs())),
            Editor(SetContent("fn main() {}".to_string())),
...
#[test]
fn parent_movement_from_non_syntax_node_selection_mode() -> anyhow::Result<()> {
    execute_test(|s| {
        Box::new([
            App(OpenFile(s.main_rs())),
            Editor(SetContent("fn main() {}".to_string())),
            Editor(SetSelectionMode(IfCurrentNotFound::LookForward, Column)),
            Editor(SelectParent),
            Expect(CurrentSelectionMode(SyntaxNode)),
...
#[test]
fn first_child_movement_from_non_syntax_node_selection_mode() -> anyhow::Result<()> {
    execute_test(|s| {
        Box::new([
            App(OpenFile(s.main_rs())),
            Editor(SetContent("fn main() {}".to_string())),
