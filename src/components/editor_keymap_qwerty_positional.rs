...
pub const MOVEMENT_MC_ENTER: &str = "e";
pub const ACTION_CHANGE: &str = "r";
pub const CLIPBOARD_CHANGE_CUT: &str = "R";
pub const ACTION_ENTER_V_MODE: &str = "t";
...
pub const SELECTION_MODE_TOKEN: &str = "d";
...
// Row 1
pub const SELECTION_MODE_LAST_CONTIGUOUS: &str = "y";
...
// Row 3
pub const ACTION_TOGGLE_MARK: &str = "n";
pub const MOVEMENT_CORE_JUMP: &str = "m";
...
// Other
pub const ACTION_SELECT_ALL: &str = "ctrl+a";
