...
mod test_render_flex_layout {
    ...
    fn test_leading_spacer() {
        ...
        assert_eq!(UnicodeWidthStr::width(joined.as_str()), 10);
    }
    ...
    fn test_middle_spacer() {
        ...
        // Join all parts to verify total width
        let joined = result.join("");
        assert_eq!(UnicodeWidthStr::width(joined.as_str()), 15);
    }
    ...
    fn test_multiple_spacers() {
        ...
        // Join all parts to verify total width
        let joined = result.join("");
        assert_eq!(UnicodeWidthStr::width(joined.as_str()), 9);
    ...
    fn test_not_enough_width() {
        ...
        // Join all parts to verify total width
        let joined = result.join("");
        assert_eq!(UnicodeWidthStr::width(joined.as_str()), 10); // Still 10 despite requesting 5
    }
    ...
    fn test_unicode_characters() {
        ...
        let joined = result.join("");
        assert_eq!(UnicodeWidthStr::width(joined.as_str()), 12);
    }
