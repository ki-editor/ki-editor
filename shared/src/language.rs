...
impl CargoLinkedTreesitterLanguage {
    pub(crate) fn to_tree_sitter_language(&self) -> tree_sitter::Language {
        match self {
            ...
            CargoLinkedTreesitterLanguage::Perl => ts_parser_perl::LANGUAGE.into(),
            ...
            CargoLinkedTreesitterLanguage::Scss => tree_sitter_scss::language(),
    ...
    fn default_highlight_query(&self) -> Option<&str> {
        match self {
            ...
            CargoLinkedTreesitterLanguage::Perl => Some(ts_parser_perl::HIGHLIGHTS_QUERY),
            ...
            CargoLinkedTreesitterLanguage::Scss => Some(tree_sitter_scss::HIGHLIGHTS_QUERY),
